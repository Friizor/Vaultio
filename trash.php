...
<head>
    ...
    <style>
        ...
        /* Styles for search, filter, sort copied from passwords.php, adapted for trash */
        .search-container {
            position: relative;
            width: 100%;
            max-width: 400px;
...
<body>
    <div class="app-container">
        ...
        <div class="dashboard-layout">
            ...
            <div class="main-content">
                <h1 class="text-2xl font-semibold text-white mb-6">Trash</h1>
                ...
                <div class="mb-6">
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
                            <div class="relative">
                                <input type="text" id="search-input" placeholder="Search trash..." class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-secondary">
                                ...
                                <div id="filter-dropdown" class="absolute left-0 mt-2 w-48 bg-[#242424] rounded-lg shadow-lg border border-gray-700 hidden z-50">
                                    <div class="p-2">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <button class="w-full text-left px-3 py-2 text-sm text-gray-300 hover:bg-gray-700 rounded-md filter-type" data-type="Password">
                                                Passwords
                                            </button>
                                            <button class="w-full text-left px-3 py-2 text-sm text-gray-300 hover:bg-gray-700 rounded-md filter-type" data-type="Note">
                                                Notes
                                            </button>
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <button class="w-full text-left px-3 py-2 text-sm text-gray-300 hover:bg-gray-700 rounded-md sort-option" data-sort="date" data-order="desc">
                                                <i class="ri-sort-desc mr-2"></i> Recently Deleted
                                            </button>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="text-left border-b border-gray-700">
                                    ...
                                    <th class="pb-3 font-medium text-gray-400">Deleted Date</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-gray-700 hover:bg-gray-700">
                                    ...
                                    <td class="py-4 text-white">Test Account</td>
                                    <td class="py-4 text-gray-400">May 20, 2024</td>
                                    <td class="py-4">
                                        <div class="flex space-x-2">
                                            <button class="text-gray-400 hover:text-white" title="Restore">
                                                <i class="ri-arrow-go-back-line"></i>
                                            </button>
                                            <button class="text-gray-400 hover:text-white" title="Delete Permanently">
    ...
    <script>
        ...
        // Add filter functionality for trash items
        ...
        // Handle type filtering (placeholder for trash items)
        document.querySelectorAll('.filter-type').forEach(button => {
            button.addEventListener('click', function() {
                const selectedType = this.dataset.type;
                console.log('Filter trash by type:', selectedType);
                // TODO: Implement actual filtering logic for trash items based on selectedType
                const dropdown = document.getElementById('filter-dropdown');
                if (dropdown) {
                    dropdown.classList.add('hidden');
                }
        ...
        // Add sort functionality for trash items
        ...
        // Handle sorting (placeholder for trash items)
        document.querySelectorAll('.sort-option').forEach(button => {
            button.addEventListener('click', function() {
                const sortBy = this.dataset.sort;
                const order = this.dataset.order;
                console.log('Sort trash by:', sortBy, order);
                // TODO: Implement actual sorting logic for trash items
                 const dropdown = document.getElementById('sort-dropdown');
                 if (dropdown) {
                    dropdown.classList.add('hidden');
                 }
        ...
        // Add search functionality for trash items
        document.getElementById('search-input').addEventListener('input', function(e) {
            const searchTerm = e.target.value.toLowerCase();
            console.log('Search trash for:', searchTerm);
            // TODO: Implement actual search logic for trash items
        });
